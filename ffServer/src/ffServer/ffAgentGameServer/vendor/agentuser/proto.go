...
var mapProtoCallback = map[ffProto.MessageType]func(agent *agentSession, proto *ffProto.Proto) bool{
...
func onProtoEnterGameWorld(agent *agentSession, proto *ffProto.Proto) bool {
...
func onProtoKeepAlive(agent *agentSession, proto *ffProto.Proto) bool {
	proto.ChangeLimitStateRecvToSend()
	agent.SendProto(proto)
	return true
}

func onProtoPrepareLoginPlatformUniqueID(agent *agentSession, proto *ffProto.Proto) bool {
	fixSalt := rand.Int31()
	for fixSalt == 0 {
		fixSalt = rand.Int31()
	}
...
func onProtoLoginPlatformUniqueID(agent *agentSession, proto *ffProto.Proto) bool {
